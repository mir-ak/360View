...
const main = () => {
  ...
  addInfoSpot(panorama1, 4500, 2050, 800, "test", 100);
  addInfoSpot(panorama1, 4500, 3850, 400, "test", 70);
  addInfoSpot(panorama1, 4500, 550, 1000, "wallStreet", 70);
  addInfoSpot(panorama1, 1500, 400, 3900, "wallStreet", 70);
  addInfoSpot(panorama1, -1500, 400, 4900, "audio", 70);
  addInfoSpot(panorama1, 3500, 1050, -3300, "republique-metro", 70);
  addInfoSpot(panorama1, -1550, 150, 1850, "Gendarmerie_nationale", 70);
  //---------------------------------------------------------------------
